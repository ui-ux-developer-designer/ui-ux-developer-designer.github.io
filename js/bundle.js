...
module.exports={name:"H & SH"};


},{}],2:[function(require,module,exports){
var templates=require("./views/templates/line.hbs");console.log(require("./data/sh/overview.yaml")),console.log(templates({name:"ILIA"}));var styles=require("./main.less");


},{"./data/sh/overview.yaml":1,"./main.less":3,"./views/templates/line.hbs":4}],3:[function(require,module,exports){
var css="html {\n  height: 100%;\n}\nbody {\n  font-size: 1.6rem;\n  font-family: open sans;\n  font-weight: 100;\n  min-height: 100%;\n  color: rgba(100, 100, 100, 0.5);\n  background: linear-gradient(45deg, #eee, #fff);\n  display: flex;\n  align-items: center;\n  justify-content: space-around;\n  flex-direction: column;\n}\nbody:after {\n  content: '';\n  opacity: .5;\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  top: 0;\n  left: 0;\n  background: url('data:image/png;base64,');\n}\n.Cube {\n  width: 80px;\n  height: 80px;\n  line-height: 80px;\n  text-align: center;\n  transform-style: preserve-3d;\n  transition: transform 0.5s 0.1s;\n  margin: auto;\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  opacity: 1;\n}\n.Cube.panelLoad {\n  z-index: 11;\n  animation: panel cubic-bezier(0.65, 0.17, 0.24, 1.02) 4.2s infinite forwards;\n}\n.Cube.panelLoad .cube-face {\n  text-shadow: 0px 0px 5px rgba(100, 100, 100, 0.3);\n}\n.Cube .cube-face {\n  border: 1px dotted;\n  perspective: 400px;\n  width: inherit;\n  height: inherit;\n  position: absolute;\n  background: white;\n}\n.Cube .cube-face-front {\n  transform: translate3d(0, 0, 40px);\n}\n.Cube .cube-face-back {\n  transform: rotateY(180deg) translate3d(0, 0, 40px);\n}\n.Cube .cube-face-left {\n  transform: rotateY(-90deg) translate3d(0, 0, 40px);\n}\n.Cube .cube-face-right {\n  transform: rotateY(90deg) translate3d(0, 0, 40px);\n}\n.Cube .cube-face-top {\n  transform: rotateX(90deg) translate3d(0, 0, 40px);\n}\n.Cube .cube-face-bottom {\n  transform: rotateX(-90deg) translate3d(0, 0, 40px);\n}\n@keyframes panel {\n  0% {\n    transform: rotateY(0deg) rotateZ(45deg);\n  }\n  20% {\n    transform: rotateY(90deg) rotateZ(0deg);\n    opacity: .9;\n  }\n  40% {\n    transform: rotateX(45deg) rotateZ(-45deg);\n  }\n  60% {\n    transform: rotateX(90deg) rotateY(180deg) rotateZ(0deg);\n    opacity: .8;\n  }\n  80% {\n    transform: rotateX(310deg) rotateZ(45deg);\n  }\n  100% {\n    transform: rotateX(360deg) rotateZ(45deg);\n  }\n}\n";require("lessify")(css),module.exports=css;


},{"lessify":26}],4:[function(require,module,exports){
var HandlebarsCompiler=require("hbsfy/runtime");module.exports=HandlebarsCompiler.template({compiler:[7,">= 4.0.0"],main:function(e,a,l,n,r){var i;return"<h1>Hello "+e.escapeExpression((i=null!=(i=l.name||(null!=a?a.name:a))?i:l.helperMissing,"function"==typeof i?i.call(null!=a?a:{},{name:"name",hash:{},data:r}):i))+"</h1>"},useData:!0});
